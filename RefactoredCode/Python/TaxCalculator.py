...
class TaxCalculator(object):
    ...
    def __init__(self, social_security_rate=0.0976, social_security_health_rate=0.015,
    ...
    def social_security_taxes(self, income):
        ...
        return {'social_security': social_security, 'social_security_health': social_security_health,
                'social_security_sickness': social_security_sickness, 'sum': all_social_taxes}
    ...
    def reduce_tax(self, income_base):
        try:
            reduced = self.advance_tax(income_base) - self.reduced_tax_rate if self.type == 'E' else self.advance_tax(
                income_base)
        except Exception as err:
    ...
    def print_all_taxes(self):
        try:
            ...
            advance_paid = advanced - health_tax[
                'health_tax_lower'] - self.reduced_tax_rate if self.type == 'E' else advanced - health_tax[
                'health_tax_lower']
            advance_paid = self.round_tax(advance_paid)
